...
const About = () => {
  return (
    <div className="about_action_page">
      <ProfilePagesWrapper heading="About">
        <div className="content">
          ...
          <p className="text-sm sm:text-base mb-2 text-center">
            ...
            indulgence services, mummy and kiddy services, car workshop
            services, charity and volunteer services, or ride hailing services,
            KnocKnoc has got you covered. Our goal is to be the first and only
            super app you need, available at all times of the day.
          </p>
          ...
          <p className="text-sm sm:text-base mb-2 text-center">
            ...
            lives of women by providing a myriad of services. We collaborate
            with over 600 cat providers to offer the best and most affordable
            care and pampering. With a variety of payment options, including buy
            now, pay later and installment plans, you can choose your preferred
            mode of payment while earning cashback and rebates.
          </p>
          <p className="text-sm sm:text-base mb-2 text-center">
